          ...
          <p className="font-leaguespartan font-semibold lg:text-3xl md:text-2xl sm:text-xl text-lg text-text">
            {inView &&
              <Typewriter
                options={{
                  delay: 30,
                  strings: ["I'm an 16 year old developer located in Moscow"],
                  loop: false,
                  autoStart: true,
