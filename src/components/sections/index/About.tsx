...
export default function About() {
    ...
    let developmentTech: Tech[] = [
        ...
        { title: "OpenCV", icon: <img alt="" draggable={false} className="h-6" src="https://res.cloudinary.com/dygcwhekh/image/upload/f_auto,q_auto/v1734169397/lukres.dev/ztf1gyeq.png" />, link: "https://opencv.org/" },
        ...
        { title: "Docker", icon: <img alt="" draggable={false} className="h-6" src="https://res.cloudinary.com/dygcwhekh/image/upload/f_auto,q_auto/v1734169384/lukres.dev/vssieasx.png" />, link: "https://www.docker.com/" },
    ...
    let otherTech: Tech[] = [
        ...
        { title: "Flipper Zero", icon: <img alt="" draggable={false} className="h-6" src="https://res.cloudinary.com/dygcwhekh/image/upload/f_auto,q_auto/v1734169250/lukres.dev/0qakmo1p.png" />, link: "https://flipperzero.one/" },
        { title: "Cloudflare", icon: <img alt="" draggable={false} className="h-6" src="https://res.cloudinary.com/dygcwhekh/image/upload/f_auto,q_auto/v1734169248/lukres.dev/me2uv8xk95n010sdwz.png" />, link: "https://www.cloudflare.com/" },
        ...
        { title: "Swift", icon: <img alt="" draggable={false} className="h-6" src="https://res.cloudinary.com/dygcwhekh/image/upload/f_auto,q_auto/v1734169303/lukres.dev/apyhav8m.png" />, link: "https://developer.apple.com/swift/" },
        { title: "DuckyScript", icon: <img alt="" draggable={false} className="h-6" src="https://res.cloudinary.com/dygcwhekh/image/upload/f_auto,q_auto/v1734169392/lukres.dev/wh9qs3vu.png" />, link: "https://github.com/hak5darren/USB-Rubber-Ducky/wiki/Duckyscript" },
        { title: "Terminal", icon: <img alt="" draggable={false} className="h-6" src="https://res.cloudinary.com/dygcwhekh/image/upload/f_auto,q_auto/v1734169343/lukres.dev/kblm9g2n.png" />, link: "https://en.wikipedia.org/wiki/Terminal_emulator" }
    ];
        ...
        <>
            <section id='about' className="max-w-4xl w-full flex flex-col mx-auto">
                ...
                <ul className="grid grid-cols-2 gap-4 mt-4">
                    ...
                    <AboutCard
                        title="Development"
                        description="I have about 6 years of experience with development, and I have worked with various languages and tools like Node.js, Docker, and PostgreSQL."
