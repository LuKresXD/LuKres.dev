...
export default function About() {
    ...
    let developmentTech: Tech[] = [
        ...
        { title: "TailwindCSS", icon: <img draggable={false} className="h-6" src="https://upload.wikimedia.org/wikipedia/commons/d/d5/Tailwind_CSS_Logo.svg" />, link: "https://tailwindcss.com/" },
