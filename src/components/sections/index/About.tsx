...
export default function About() {
    ...
    let developmentTech: Tech[] = [
        ...
        { title: "OpenCV", icon: <img draggable={false} className="h-6" src="https://res.cloudinary.com/dygcwhekh/image/upload/v1734169397/lukres.dev/ztf1gyeq.png" />, link: "https://opencv.org/" },
        ...
        { title: "Docker", icon: <img draggable={false} className="h-6" src="https://res.cloudinary.com/dygcwhekh/image/upload/v1734169384/lukres.dev/vssieasx.png" />, link: "https://www.docker.com/" },
    ...
    let otherTech: Tech[] = [
        ...
        { title: "Flipper Zero", icon: <img draggable={false} className="h-6" src="https://res.cloudinary.com/dygcwhekh/image/upload/v1734169250/lukres.dev/0qakmo1p.png" />, link: "https://flipperzero.one/" },
        { title: "Cloudflare", icon: <img draggable={false} className="h-6" src="https://res.cloudinary.com/dygcwhekh/image/upload/v1734169248/lukres.dev/me2uv8xk95n010sdwz.png" />, link: "https://www.cloudflare.com/" },
        ...
        { title: "Swift", icon: <img draggable={false} className="h-6" src="https://res.cloudinary.com/dygcwhekh/image/upload/v1734169303/lukres.dev/apyhav8m.png" />, link: "https://developer.apple.com/swift/" },
        { title: "DuckyScript", icon: <img draggable={false} className="h-6" src="https://res.cloudinary.com/dygcwhekh/image/upload/v1734169392/lukres.dev/wh9qs3vu.png" />, link: "https://github.com/hak5darren/USB-Rubber-Ducky/wiki/Duckyscript" },
        { title: "Terminal", icon: <img draggable={false} className="h-6" src="https://res.cloudinary.com/dygcwhekh/image/upload/v1734169343/lukres.dev/kblm9g2n.png" />, link: "https://en.wikipedia.org/wiki/Terminal_emulator" }
    ];
