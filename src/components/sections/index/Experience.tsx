            ...
            <section id='experience' className="max-w-4xl w-full flex flex-col mx-auto">
                ...
                <ul className={`flex flex-col pt-6 pb-1 gap-4 overflow-hidden`}>
                    <ExperienceCard
                        ...
                        cardImage="https://res.cloudinary.com/dygcwhekh/image/upload/v1734169389/lukres.dev/wct56v7g.png"
                        ...
                        media={["https://res.cloudinary.com/dygcwhekh/video/upload/v1734169357/lukres.dev/pg0pmfvm.mp4"]}
                        myRole="Intern"
                    ...
                    <ExperienceCard
                        ...
                        cardImage="https://res.cloudinary.com/dygcwhekh/image/upload/v1734169306/lukres.dev/b6p49co9.png"
                        ...
                        media={["https://res.cloudinary.com/dygcwhekh/video/upload/v1734169395/lukres.dev/wuctgw84.mp4"]}
                        myRole="Intern"
